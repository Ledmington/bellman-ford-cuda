...
\begin{document}
	...
	\begin{table}[!ht]
		...
		\begin{tabular}{|l|c|c|c|}
			...
			\textbf{Nome GPU} & GeForce 940MX & GeForce GTX 1070 & GeForce RTX 2080 \\ \hline
	...
	\subsection{Prestazioni dell'algoritmo seriale}
	\begin{table}[!ht]
		\centering
		\begin{tabular}{|c|c|c|}
			\hline
		...
		\caption{Prestazioni dell'algoritmo seriale su CPU della macchina "940MX"}
	\end{table}
	...
	Entrando più nello specifico, tutti i grafi elencati sono orientati, pesati e semplici. I primi 5 sono planari mentre gli altri 4 no. L'ultimo grafo, \texttt{100}, è l'unico completo. I primi cinque grafi sono considerati sparsi, gli ultimi quattro sono considerati densi. In nessuno di questi grafi sono presenti nodi isolati.
	\begin{table}[!ht]
		\centering
	...
	\subsection{Precisazioni preliminari}
	...
	\begin{figure}[!ht]
		\centering
		\includegraphics[width=0.7\linewidth]{speedup_bf0-none-aos-nosh}
		\caption{Speedup di \texttt{bf0-none-aos-nosh}}
		\label{fig:speedup_bf0-none-aos-nosh}
	\end{figure}

	\begin{figure}[!ht]
		\centering
		\includegraphics[width=0.7\linewidth]{speedup_bf0-none-aos-sh}
		\caption{Speedup di \texttt{bf0-none-aos-sh}}
		\label{fig:speedup_bf0-none-aos-sh}
	\end{figure}

	\begin{figure}[!ht]
		\centering
		\includegraphics[width=0.7\linewidth]{speedup_bf0-none-soa-nosh}
		\caption{Speedup di \texttt{bf0-none-soa-nosh}}
		\label{fig:speedup_bf0-none-soa-nosh}
	\end{figure}

	\begin{figure}[!ht]
		\centering
		\includegraphics[width=0.7\linewidth]{speedup_bf0-none-soa-sh}
		\caption{Speedup di \texttt{bf0-none-soa-sh}}
		\label{fig:speedup_bf0-none-soa-sh}
	\end{figure}

	\begin{figure}[!ht]
		\centering
		\includegraphics[width=0.7\linewidth]{speedup_bf0-mutex-aos-nosh}
		\caption{Speedup di \texttt{bf0-mutex-aos-nosh}}
		\label{fig:speedup_bf0-mutex-aos-nosh}
	\end{figure}

	\begin{figure}[!ht]
		\centering
		\includegraphics[width=0.7\linewidth]{speedup_bf0-mutex-aos-sh}
		\caption{Speedup di \texttt{bf0-mutex-aos-sh}}
		\label{fig:speedup_bf0-mutex-aos-sh}
	\end{figure}

	\begin{figure}[!ht]
		\centering
		\includegraphics[width=0.7\linewidth]{speedup_bf0-mutex-soa-nosh}
		\caption{Speedup di \texttt{bf0-mutex-soa-nosh}}
		\label{fig:speedup_bf0-mutex-soa-nosh}
	\end{figure}

	\begin{figure}[!ht]
		\centering
		\includegraphics[width=0.7\linewidth]{speedup_bf0-mutex-soa-sh}
		\caption{Speedup di \texttt{bf0-mutex-soa-sh}}
		\label{fig:speedup_bf0-mutex-soa-sh}
	\end{figure}
	...
	\begin{figure}[!ht]
		\centering
		\includegraphics[width=0.7\linewidth]{throughput_bf0-none-aos-nosh}
		\caption{Throughput di \texttt{bf0-none-aos-nosh}}
		\label{fig:throughput_bf0-none-aos-nosh}
	\end{figure}

	\begin{figure}[!ht]
		\centering
		\includegraphics[width=0.7\linewidth]{throughput_bf0-none-aos-sh}
		\caption{Throughput di \texttt{bf0-none-aos-sh}}
		\label{fig:throughput_bf0-none-aos-sh}
	\end{figure}

	\begin{figure}[!ht]
		\centering
		\includegraphics[width=0.7\linewidth]{throughput_bf0-none-soa-nosh}
		\caption{Throughput di \texttt{bf0-none-soa-nosh}}
		\label{fig:throughput_bf0-none-soa-nosh}
	\end{figure}

	\begin{figure}[!ht]
		\centering
		\includegraphics[width=0.7\linewidth]{throughput_bf0-none-soa-sh}
		\caption{Throughput di \texttt{bf0-none-soa-sh}}
		\label{fig:throughput_bf0-none-soa-sh}
	\end{figure}

	\begin{figure}[!ht]
		\centering
		\includegraphics[width=0.7\linewidth]{throughput_bf0-mutex-aos-nosh}
		\caption{Throughput di \texttt{bf0-mutex-aos-nosh}}
		\label{fig:throughput_bf0-mutex-aos-nosh}
	\end{figure}

	\begin{figure}[!ht]
		\centering
		\includegraphics[width=0.7\linewidth]{throughput_bf0-mutex-aos-sh}
		\caption{Throughput di \texttt{bf0-mutex-aos-sh}}
		\label{fig:throughput_bf0-mutex-aos-sh}
	\end{figure}

	\begin{figure}[!ht]
		\centering
		\includegraphics[width=0.7\linewidth]{throughput_bf0-mutex-soa-nosh}
		\caption{Throughput di \texttt{bf0-mutex-soa-nosh}}
		\label{fig:throughput_bf0-mutex-soa-nosh}
	\end{figure}

	\begin{figure}[!ht]
		\centering
		\includegraphics[width=0.7\linewidth]{throughput_bf0-mutex-soa-sh}
		\caption{Throughput di \texttt{bf0-mutex-soa-sh}}
		\label{fig:throughput_bf0-mutex-soa-sh}
	\end{figure}
