...
\begin{document}
	...
	\begin{table}[!ht]
		...
		\begin{tabular}{|l|c|c|c|}
			...
			\textbf{Versione OS} & 10.0.19042.1165 & 16.04.7 & \\ \hline
			\textbf{Versione NVCC} & & & \\ \hline
			\textbf{Versione GCC/CL} & & & \\ \hline
			\textbf{Nome CPU} & Intel Core i5-7200U & Intel Xeon E5-2603 v4 & \\ \hline
			\textbf{Frequenza CPU} & 2,5 - 2,7 GHz & 1,2 - 1,7 GHz & \\ \hline
			\textbf{Core fisici} & 2 & 6 & \\ \hline
			\textbf{Hyper-Threading} & si & no & \\ \hline
			\textbf{L1 cache} & 128 KB & 32 KB & \\ \hline
			\textbf{L2 cache} & 512 KB & 256 KB & \\ \hline
			\textbf{L3 cache} & 3 MB & 15 MB & \\ \hline
			...
			\textbf{Memory Bus} & 64 bit & 256 bit & 256 bit \\ \hline
