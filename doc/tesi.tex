...
\begin{document}
	...
	Lo speedup è la principale metrica di misurazione di un programma parallelo. Essa, infatti, rappresenta l'accelerazione che il programma ha ricevuto tramite la parallelizzazione.
